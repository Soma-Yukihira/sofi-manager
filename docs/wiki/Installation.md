...
If you'd rather skip the Python setup and ship a single double-clickable
app to your machine, build a Windows executable:

```bash
python tools/build.py
```

See [Building](Building) for the full layout, options, and
troubleshooting.
